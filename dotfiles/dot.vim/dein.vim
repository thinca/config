...
call dein#add('CSApprox', {'lazy': 1})
call dein#add('Colour-Sampler-Pack', {'lazy': 1})
...
call dein#add('kannokanno/previm', {'on_cmd': 'PrevimOpen', 'on_ft': ['markdown', 'textile']})
