...
call dein#add('monaqa/vim-duzzle', {'on_cmd': 'DuzzleStart'})
...
call dein#add('lambdalisue/vim-mr')
...
call dein#add('rbtnn/vim-emphasiscursor')
call dein#add('rhysd/clever-f.vim')
" call dein#add('rhysd/committia.vim')
call dein#add('thinca/committia.vim', {'rev': 'remove-dependence-on-vimproc'})
...
call dein#add('4513ECHO/denops-gitter.vim')
